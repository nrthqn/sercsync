...
<html>
	<head>
		<title> Games News - SERCsync </title>
	...
	<body>
		...
		<div class="container">
					...
					<div class="container">
						<div class="box1">
							<a href="https://gameranx.com/updates/id/496505/article/director-of-assassins-creed-mirage-has-more-ideas-for-basims-story/">
								...
								<div class="textbox10">
									<pp>
										More Ideas For Basim's Story<br> <br>
						...
						<div class="box2">
							<a href="https://blog.playstation.com/2024/04/24/new-gran-turismo-7-update-features-an-all-electric-concept-racing-car-created-exclusively-for-the-game/">
								...
								<div class="textbox10">
									<pp>
										New Gran Turismo 7 update features an all-electric concept racing car created exclusively for the game<br> <br>
						...
						<div class="box3">
							<div class="box10">
								<a href="https://www.gamesradar.com/games/third-person-shooter/helldivers-2-dev-says-they-dont-know-if-the-shooter-will-ever-go-bigger-than-4-player-squads-but-it-would-require-a-lot-of-work/">
									...
									<div class="textbox10">
										<pp>
											Helldivers 4+ player teams?<br> <br>
			...
			<section class="containerNine">
				<div class="containerNine-container">
						<hh2>HOTTEST ARTICLES</hh2>
					<div class="container">
						<div class="box4">
							<a href="https://www.gamesradar.com/stellar-blade-release-time-countdown/">
								<img src="shiftup.png" alt="Stellar Blade - Image credits ShiftUp"> 
							</a>
								<div class="textbox10">
									<pp>
										Stellar Blade release time - the countdown to the new PS5 action RPG is on<br> <br>
									</pp>
									<pp1>
										If you're one of the fans who played the Stellar Blade demo enough to "scare" developer Shift Up, you'll likely know what the opening is all about. <br><br> If you don't, though, you play as Eve, a 7th Airborne Squad member who is off to Earth to aid in reclaiming it from a foe called the Naytiba. You'll start with a tutorial before hitting some enemies until you reach a boss. <br><br> The good news, though, is that you won't have to repeat that if you've played the demo as save progress carries over. 
										The opening sets the tone for the rest of the hack-and-slash adventure. <br><br> The developer behind the game hasn't been shy about calling out gameplay inspirations like Nier Automata or how Yukito Kishiro's manga Gunnm helps inform the '80s and '90s sci-fi aesthetic. The core theme, however, was inspired by a real-life taxi driver strike that left an impression on the RPG's director.
										<br><br> Source - Games Radar 
										<br><br> Click the image to read more!	
									</pp1>
								</div>
						...
						<div class="box5">
							<a href="https://www.ign.com/articles/dragons-dogma-2-has-done-so-well-capcom-is-paying-out-more-money-to-shareholders">
								...
								<div class="textbox10">
									<pp>
										Dragon's Dogma 2 Has Done So Well Capcom Is Paying Out More Money to Shareholders<br> <br>
										Capcom Says It's Going to Make More Money Than Expected After Dragon's Dogma 2 Success									
										Dragon's Dogma 2 is a big hit for Capcom, selling 2.5 million copies across PC via Steam, PlayStation 5, and Xbox Series X and S in just 11 days. <br><br> The sprawling action role-playing game went on sale on March 22, and Capcom announced Dragon’s Dogma 2 had passed 2.5 million sold on April 2. Total Dragon’s Dogma franchise sales have now exceeded 10 million units, Capcom added.
										<br><br>It took the first Dragon's Dogma game a month to sell 1.05 million units after it went on sale at the end of May 2012, a tally Capcom declared a success at the time.
									</pp>
									<pp1>
										<br><br> Source - IGN 
										<br><br> Click the image to read more!	
			...
			<section class="containerTen">
				<div class="containerTen-container">
