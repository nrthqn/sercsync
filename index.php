...
<html>
	...
	<body>
		...
		<div class="cardFull">
			...
			<div class="cardLarge">
				<div class="box11">
					...
					<div class="textbox10">
						<hh2> WELCOME TO SERCSYNC GAMER'S HUB<br> </hh2>
						<pp><br>Explore our Games News webpage to find out all the latest details in the gaming world<br>
							<br>Create an account and keep your own Games Library to track your favourite games, it's on us!<br>
							<br>Get in touch and let us know what else you want us to do!<br>
						</pp>
					</div>
				</div>
			</div>
		...
		<!-- FULL WIDTH CARD NO. 2 -->
		<div class="cardFull">
			<div class="cardColour">
				<hh3> THE HOTTEST GAMES ON THESE PLATFORMS! </hh3>
			</div>
		</div>
		...
		<div class="cards">
			<div class="card">
				<div class="box10">
					<a href="https://www.xbox.com/en-GB/games/forza-horizon-4">
						<img src="fh4.png" alt="Forza Horizon 4 - Image credits Microsoft"> 
					</a>
					<div class="textbox10">
						<hh2> XBOX <br> Forza Horizon 4 <br> </hh2>
						<pp>Open-world racing never looked this beautiful.</pp>
					</div>
				</div>
			</div>
			...
			<div class="card">
				<div class="box10">
					...
					<div class="textbox10">
						<hh2> PLAYSTATION <br> Helldivers <br> </hh2>
						<pp> Part of the elite unit called the HELLDIVERS, protect SUPER EARTH.</pp>
					</div>
				</div>
			</div>
			...
			<div class="card">
				<div class="box10">
					<a href="https://store.steampowered.com/app/1086940/Baldurs_Gate_3/">
						<img src="bg3.png" alt="Baldur's Gate 3 - Image credits GamesInHand"> 
					</a>
					<div class="textbox10">
						<hh2> PC <br> Baldur's Gate 3 <br> </hh2>
						<pp>A story-rich, party-based RPG set in the universe of Dungeons & Dragons.</pp>
					</div>
				</div>
			</div>
		</div> 
	...
	<div class="cardFull">
		<div class="cardColour">
			<hh3> WANT TO HEAR MORE FROM US OR REACH OUT? </hh3>
		</div>
	</div>
